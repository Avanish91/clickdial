...
const Dashboard = ({ navigation }) => {
  ...
  const data = [
    { x: 'Food', y: 22, name: 'Food', color: '#f39c12' },
    { x: 'Transport', y: 15, name: 'Transport', color: '#2ecc71' },
    { x: 'Shopping', y: 30, name: 'Shopping', color: '#e74c3c' },
    { x: 'Other', y: 10, name: 'Other', color: '#9b59b6' },
  ];
  ...
  const handleOutsidePress = () => {
    if (selectedCategory) {
      setSelectedCategory(null); // ❌ Deselect on outside press
    }
    Keyboard.dismiss(); // In case keyboard is open
  };
  ...
  for (let i = 0; i < 2; i++) {
    LabelList.push(
      <View style={[styles.dashboardChartLabelContainer]} key={i}>
        ...
        ></View>
        <Text style={styles.dashboardChartLabelTextOne}>
          {i === 0 ? 'Complete' : 'Cancel'}
        </Text>
  ...
  const getDashboardDetail = () => {
    ...
    axios
      .post(url, { vId: global.vId, deviceId: global.deviceId })
      .then(res => {
        const test = [];
      ...
      <ScrollView style={styles.scrollView}>
        <View style={[styles.container, { height: 765 }]}>
          ...
          <View style={styles.editPagesMainContainer}>
            ...
            <View
              style={[
                styles.dashboardBoxContainer,
                { height: 182, paddingTop: 0 },
              ]}
            >
              <View
                style={[styles.dashboardChartMainContainer, { height: 180 }]}
              >
                <TouchableOpacity
                  style={[styles.dashboardChartContainer, { height: 180 }]}
                ...
                <View style={[styles.dashboardChartLabelMainContainer]}>
                  <ScrollView nestedScrollEnabled={true}>
                    <ScrollView nestedScrollEnabled={true} horizontal={true}>
                      <View
                        style={[
                          styles.dashboardChartLabelMainContainerLeft,
                          { marginTop: 20 },
                        ]}
                      >
                ...
                >
                  <View style={{}}>
                    <View style={styles.dashboardLinearTabsLeft}>
                      ...
                      <Text style={styles.dashboardLinearTabsLeftTextOne}>
                        New Enquiry
                      </Text>
                      <Text style={styles.dashboardLinearTabsLeftTextTwo}>
                        {dashboardData.dNew}
                      </Text>
                    </View>
                  </View>
